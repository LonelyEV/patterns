package onem.quzhigang.patterns;
...
public class PahoTlsExample {
	...
	private static void connect() {
        ...
        int qos             = 2;
        String broker       = "ssl://192.168.21.224:8883";
        ...
        try {
            ...
            try {
            	File file = new File("F:\\crt\\cacert.crt");
            	System.out.println(file.length());
                factory = getSSLSocktet("F:\\crt\\cacert.crt","F:\\crt\\client.crt","F:\\crt\\client-key-pkcs8.pem","123456");
            } catch (Exception e) {
